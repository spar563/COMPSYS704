...
public class Plant extends ClockDomain{
  ...
  public void thread3352(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3359 = 0;
        if(ends[8]>=biggest3359){
          biggest3359=ends[8];
        }
        if(ends[9]>=biggest3359){
          biggest3359=ends[9];
        }
        if(ends[10]>=biggest3359){
          biggest3359=ends[10];
        }
        if(ends[11]>=biggest3359){
          biggest3359=ends[11];
        }
        if(ends[12]>=biggest3359){
          biggest3359=ends[12];
        }
        if(ends[13]>=biggest3359){
          biggest3359=ends[13];
        }
        if(biggest3359 == 1){
          active[7]=1;
  ...
  public void thread3338(int [] tdone, int [] ends){
    ...
    int biggest3345 = 0;
    if(ends[8]>=biggest3345){
      biggest3345=ends[8];
    }
    if(ends[9]>=biggest3345){
      biggest3345=ends[9];
    }
    if(ends[10]>=biggest3345){
      biggest3345=ends[10];
    }
    if(ends[11]>=biggest3345){
      biggest3345=ends[11];
    }
    if(ends[12]>=biggest3345){
      biggest3345=ends[12];
    }
    if(ends[13]>=biggest3345){
      biggest3345=ends[13];
    }
    if(biggest3345 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S3331){
        ...
        case 1 : 
          ...
          int biggest3346 = 0;
          if(ends[2]>=biggest3346){
            biggest3346=ends[2];
          }
          if(ends[3]>=biggest3346){
            biggest3346=ends[3];
          }
          if(ends[4]>=biggest3346){
            biggest3346=ends[4];
          }
          if(ends[5]>=biggest3346){
            biggest3346=ends[5];
          }
          if(ends[6]>=biggest3346){
            biggest3346=ends[6];
          }
          if(ends[7]>=biggest3346){
            biggest3346=ends[7];
          }
          if(biggest3346 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3360 = 0;
          if(ends[2]>=biggest3360){
            biggest3360=ends[2];
          }
          if(ends[3]>=biggest3360){
            biggest3360=ends[3];
          }
          if(ends[4]>=biggest3360){
            biggest3360=ends[4];
          }
          if(ends[5]>=biggest3360){
            biggest3360=ends[5];
          }
          if(ends[6]>=biggest3360){
            biggest3360=ends[6];
          }
          if(ends[7]>=biggest3360){
            biggest3360=ends[7];
          }
          if(biggest3360 == 1){
            active[1]=1;
