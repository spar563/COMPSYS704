...
public class BufferCD extends ClockDomain{
  ...
  private Buffer myBuffer_thread_12;//sysj/Exercise6.sysj line: 132, column: 3
  private int data_thread_12;//sysj/Exercise6.sysj line: 133, column: 3
  private int S1482 = 1;
  private int S774 = 1;
  private int S773 = 1;
  private int S647 = 1;
  ...
  public void thread1514(int [] tdone, int [] ends){
      ...
      case 1 : 
        switch(S1355){
          case 0 : 
            S1355=0;
            if(toBuffer_9.getprestatus()){//sysj/Exercise6.sysj line: 137, column: 12
              myBuffer_thread_12.push((toBuffer_9.getpreval() == null ? null : ((Integer)toBuffer_9.getpreval())));//sysj/Exercise6.sysj line: 138, column: 5
              if(requestData_9.getprestatus()){//sysj/Exercise6.sysj line: 141, column: 12
                data_thread_12 = ((Integer)myBuffer_thread_12.pop()).intValue();//sysj/Exercise6.sysj line: 142, column: 5
                fromBuffer_9.setPresent();//sysj/Exercise6.sysj line: 143, column: 5
                currsigs.addElement(fromBuffer_9);
                fromBuffer_9.setValue(data_thread_12);//sysj/Exercise6.sysj line: 143, column: 5
                System.out.println("Emitted fromBuffer_9");
                if(!myBuffer_thread_12.isFull()){//sysj/Exercise6.sysj line: 145, column: 7
                  bufferNotFull_9.setPresent();//sysj/Exercise6.sysj line: 146, column: 5
                  currsigs.addElement(bufferNotFull_9);
                  System.out.println("Emitted bufferNotFull_9");
                  if(!myBuffer_thread_12.isEmpty()){//sysj/Exercise6.sysj line: 148, column: 7
                    bufferNotEmpty_9.setPresent();//sysj/Exercise6.sysj line: 149, column: 5
  ...
  public void thread1513(int [] tdone, int [] ends){
        switch(S1346){
      case 0 : 
        active[11]=0;
        ends[11]=0;
            ...
            switch(S869){
              case 0 : 
                switch(S775){
                  ...
                  case 1 : 
                    S775=1;
                    S775=2;
                    if(fromBuffer_9.getprestatus()){//sysj/Exercise6.sysj line: 119, column: 13
                      data_thread_11 = (fromBuffer_9.getpreval() == null ? null : ((Integer)fromBuffer_9.getpreval()));//sysj/Exercise6.sysj line: 120, column: 9
                      S782=0;
                      if(!consumerChannel_o.isPartnerPresent() || consumerChannel_o.isPartnerPreempted()){//sysj/Exercise6.sysj line: 121, column: 9
                        consumerChannel_o.setREQ(false);//sysj/Exercise6.sysj line: 121, column: 9
                        S782=1;
                        active[11]=1;
                        ends[11]=1;
                        tdone[11]=1;
                        ...
                        S777=0;
                        if(consumerChannel_o.isACK()){//sysj/Exercise6.sysj line: 121, column: 9
                          consumerChannel_o.setVal(data_thread_11);//sysj/Exercise6.sysj line: 121, column: 9
                          S777=1;
                          if(!consumerChannel_o.isACK()){//sysj/Exercise6.sysj line: 121, column: 9
                            consumerChannel_o.setREQ(false);//sysj/Exercise6.sysj line: 121, column: 9
                            ends[11]=2;
                            ;//sysj/Exercise6.sysj line: 121, column: 9
                            S869=1;
                            active[11]=1;
                            ends[11]=1;
                            tdone[11]=1;
              ...
              case 1 : 
                ...
                if(bufferNotEmpty_9.getprestatus()){//sysj/Exercise6.sysj line: 104, column: 12
                  requestData_9.setPresent();//sysj/Exercise6.sysj line: 107, column: 5
                  currsigs.addElement(requestData_9);
                  System.out.println("Emitted requestData_9");
                  S775=0;
                  active[11]=1;
                  ends[11]=1;
                  tdone[11]=1;
                            ...
                            case 0 : 
                              if(!producerChannel_in.isREQ()){//sysj/Exercise6.sysj line: 87, column: 5
                                ...
                                if(producerChannel_in.isREQ()){//sysj/Exercise6.sysj line: 87, column: 5
                                  ...
                                  data_thread_10 = (producerChannel_in.getVal() == null ? 0 : ((Integer)producerChannel_in.getVal()).intValue());//sysj/Exercise6.sysj line: 89, column: 5
  ...
  public void thread1510(int [] tdone, int [] ends){
        S1480=1;
    myBuffer_thread_12 = new Buffer(100);//sysj/Exercise6.sysj line: 132, column: 3
    data_thread_12 = 0;//sysj/Exercise6.sysj line: 133, column: 3
    S1355=0;
    if(toBuffer_9.getprestatus()){//sysj/Exercise6.sysj line: 137, column: 12
      myBuffer_thread_12.push((toBuffer_9.getpreval() == null ? null : ((Integer)toBuffer_9.getpreval())));//sysj/Exercise6.sysj line: 138, column: 5
      if(requestData_9.getprestatus()){//sysj/Exercise6.sysj line: 141, column: 12
    ...
    RUN: while(true){
      switch(S1482){
        ...
        case 1 : 
          ...
          thread1510(tdone,ends);
          int biggest1511 = 0;
          if(ends[10]>=biggest1511){
            biggest1511=ends[10];
          }
          if(ends[11]>=biggest1511){
            biggest1511=ends[11];
          }
          if(ends[12]>=biggest1511){
            biggest1511=ends[12];
          }
          if(biggest1511 == 1){
            active[9]=1;
        ...
        case 2 : 
          ...
          thread1513(tdone,ends);
          thread1514(tdone,ends);
          int biggest1515 = 0;
          if(ends[10]>=biggest1515){
            biggest1515=ends[10];
          }
          if(ends[11]>=biggest1515){
            biggest1515=ends[11];
          }
          if(ends[12]>=biggest1515){
            biggest1515=ends[12];
          }
          if(biggest1515 == 1){
            active[9]=1;
